 ...
 */
print("You aren't allowed to change a constant and in the indication above it told us to change the constant that was already declared so it doesn't comile properly")
